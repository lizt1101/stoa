...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/oaApply/">申请列表</a></li>
		<li class="active"><a href="${ctx}/oa/oaApply/form?id=${oaApply.id}">申请<shiro:hasPermission name="oa:oaApply:edit">${not empty oaApply.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaApply:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaApply" action="${ctx}/oa/oaApply/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">申请的跳转链接</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">申请所属类别</label>
			<div class="controls">
