...
public class LeaveService extends BaseService {
	...
	public void save(Leave leave, Map<String, Object> variables) {
		...
		// 启动流程
		//String procInsId = actTaskService.startProcess(ActUtils.PD_LEAVE[0], ActUtils.PD_LEAVE[1], leave.getId(), leave.getCreateBy().getName()+"请假",vars);
		String businessKey = leave.getId().toString();
		variables.put("type", "leave");
		variables.put("busId", businessKey);
		ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(ActUtils.PD_LEAVE[0], ActUtils.PD_LEAVE[1]+":"+leave.getId(), variables);
