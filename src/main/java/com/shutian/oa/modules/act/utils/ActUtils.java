...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_COST_REIM = new String[]{"cost_reim","oa_cost_reimbursement"};
	public static final String[] PD_ASKFOR_LEAVE = new String[]{"askForLeave","oa_askfor_leave"};
...
//	}
	...
	public static String getFormUrl(String formKey, Act act){
		...
		if(act.getDetailFlag()!=null && act.getDetailFlag().equals("1")){ //跳详情接口标识
			formUrl.append("&act.detailFlag=").append(act.getDetailFlag() != null ? act.getDetailFlag() : "");
		}
